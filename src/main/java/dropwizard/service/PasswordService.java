...
public class PasswordService {
    ...
    /**
     * This methods calls gets called when there is an exception
     */
    ...
    /**
     * This method creates an hashed password on base of the input.
     *
    ...
    /**
     * This method calls the static method verifyPassword
     * to compare the String password with the hash.
     *
     * @param password the String password
     * @param correctHash the correct hash
     * @return true or false whether password matches hash
    ...
    /**
     * @param password the String password
     * @param correctHash the correct hash of the password
     * @return true or false whether password matches hash
     * @throws CannotPerformOperationException
     * @throws InvalidHashException
     */
     ...
     * This method creates an hashed password on base of the input.
     *
     * @param a hashed password
     *@param b hashed password
     * @return true or false whether hashes match
     */
     ...
     * @param bytes length of the original hash
     * @return byte[] of of the input
     * @throws CannotPerformOperationException
     * @throws InvalidHashException
     */
    ...
    /**
     * This method creates a randomly generated string.
     *
     * @return random generated String
     */
    public String generatePassword() {
        String uuid = UUID.randomUUID().toString();
        String password[] = uuid.split("-");
